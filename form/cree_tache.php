...
<div id="wrapper">
     <!-- Navigation -->
		...
		<div class="xs">
		            <p> <?php
 $aa=$_POST["nom"];
$bb=$_POST["description_tache"];
$cc=$_POST["date-attachement"]; 
$dd=$_POST["atache"];  
$ee=$_POST["phase"];
$jj="false";
include("connexion_bdd.php");
$requete="INSERT INTO `tache`(`nom_tache`,`description_tache`,`date_attachemen`,`id_phase`,`attache_a`,`termine_tch`) 
                         values('$aa','$bb','$cc','$ee','$dd','$jj')";
